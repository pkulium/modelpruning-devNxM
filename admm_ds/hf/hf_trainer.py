...
from ..admm_disabled_optimizer import ADMMDisabledOptimizer
...
class ADMMArguments:
    ...
    admm_config: Union[str, HFTransformerADMMConfig] = field(
        default=None,
...
class ADMMTrainer(Trainer):
    ...
    def _wrap_model(self, model, training=True):
        ...
        # so. Should be revisited when we look into systems-level optimizations, but
